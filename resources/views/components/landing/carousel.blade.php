    ...
    <div id="heroCarousel" data-bs-interval="4000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <a href="#portfolio" class="btn-get-started animate__animated animate__fadeInUp scrollto">Layanan Kami</a>
              </div>
            </div>
          </div>
  
          <!-- Slide 2 -->
          <div class="carousel-item" style="background-image: url({{ asset("assets/img/slide/maryam.jpg") }})">
            <div class="carousel-container">
              <div class="container">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background-image: url({{ asset("assets/img/slide/salam.jpeg") }})">
            <div class="carousel-container">
              <div class="container">
